...
Last synced with the live routines on 2026-09-14 (third update that day: the Sunday sweep runs B2, B3's deep pass and QC Tier 2 only and drafts no email; Monday's daily scan covers the weekend and emails the sweep's results).
