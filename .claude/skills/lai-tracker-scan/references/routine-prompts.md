...
Last synced with the live routines on 2026-09-14 (fourth update that day: every dashboard text field is written with a Korean `_ko` copy; the email stays English).
